      ...
      <div className={cn(
        ...
        <div className='ml-auto flex items-center gap-2'>
          {!['mi_cuenta', 'usuarios', 'auditoria', 'alertas'].includes(tab) && activeTemplate && (
            <div className='hidden sm:flex items-center gap-1.5 text-[10px] font-medium px-2 py-1 rounded-full border font-terminal border-green-500/30 bg-green-500/10 text-green-700 dark:text-green-400'>
